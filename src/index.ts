...
server.setRequestHandler(ListToolsRequestSchema, async () => {
  return {
    tools: [
      ...
      {
        name: 'feature_sync',
        description: 'Sync a feature branch with the latest main branch, automatically resolving conflicts with AI assistance',
        inputSchema: {
          type: 'object',
          properties: {
            featureName: {
              type: 'string',
              description: 'Name of the feature to sync (must match existing worktree)',
            },
          },
